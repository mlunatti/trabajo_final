...
module.exports = async function(req, res, next){
    ...
    if( req.header('Authorization') && req.header('Authorization').split(' ').length > 1 ){
        try {
              //Verifico el token y lo decodifico con la clave secreta para obtener los datos del usuario que lo creo 
              //y los guardo en la variable  
              ...
              res.locals.usuario = usuario // me puedo guardar el usuario en el locals para usarlo en las rutas que nexesiten el Usuario
